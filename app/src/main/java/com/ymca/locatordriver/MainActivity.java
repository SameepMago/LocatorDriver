...
public class MainActivity extends Activity implements
    ...
    private void updateUI() {
        if(mCurrentLocation!=null) {
            ...
            //sendIdToServer((mCurrentLocation.getLatitude()), mCurrentLocation.getLongitude());
            mLastUpdateTimeTextView.setText(String.format("%s: %s", mLastUpdateTimeLabel,
                    mLastUpdateTime));
            speed.setText("Current Speed" + String.valueOf(mCurrentLocation.getSpeed()));
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (mCurrentLocation == null) {if (ContextCompat.checkSelfPermission(this,
    ...
    /*private void sendIdToServer(final double latitude,final double longitude) {

        StringRequest req = new StringRequest(Request.Method.POST,"https://magovishal09.000webhostapp.com/location.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("","Response"+response);
                        Log.d("","Hello"+String.valueOf(latitude));
                        //if the server returned the string success

                        Toast.makeText(MainActivity.this, "Sent Location", Toast.LENGTH_SHORT).show();
